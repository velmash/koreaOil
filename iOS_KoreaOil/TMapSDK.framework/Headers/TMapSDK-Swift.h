...
- (void)onConfigurationLoaderError:(int32_t)errorCode;
...
- (void)mapViewDidSingleTap:(UIView * _Null_unspecified)mapView screenPoint:(CGPoint)screenPoint;
- (void)mapViewDidDoubleTap:(UIView * _Null_unspecified)mapView screenPoint:(CGPoint)screenPoint;
@end
